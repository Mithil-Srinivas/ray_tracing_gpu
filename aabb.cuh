...
struct aabb
{
    ...
    __host__ aabb(const interval& x, const interval& y, const interval& z)
        : x(x), y(y), z(z)
    {
        pad_to_minimums();
    }

    __host__ aabb(const point3& a, const point3& b) {
    ...
    __host__ aabb(const aabb& box0, const aabb& box1){
