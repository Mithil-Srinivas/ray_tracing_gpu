...
// }
//
// void bouncing_instances(camera *cam, int width, int height, bvh *world, materials *materials_arr, rng &rando)
// {
//     new (cam) camera();
//
//     cam->background = color(0.7, 0.8, 1.0);
...
//
//     dielectrics.emplace_back(1.5);
//     instances.emplace_back(1, spheres[1].abs_offset({0, 1, 0}), DIELECTRIC, 0);
//
//     metals.emplace_back(color(0.7, 0.6, 0.5), 0.0);
//     instances.emplace_back(1, spheres[1].abs_offset({4, 1, 0}), METAL, 0);
//
...
//                     auto albedo = color::random(rando) * color::random(rando);
//                     lambertians.emplace_back(albedo);
//                     instances.emplace_back(2, spheres[2].abs_offset(center), LAMBERTIAN, lambertians.size()-1);
//                 }else if (choose_mat < 0.95)
//                 {
//                     //metal
//                     auto albedo = color::random(rando) * color::random(rando);
//                     auto fuzz = rando.next_real(0, 1);
//                     metals.emplace_back(albedo, fuzz);
//                     instances.emplace_back(2, spheres[2].abs_offset(center), METAL, metals.size()-1);
//                 }else
//                 {
//                     //glass
//                     dielectrics.emplace_back(1.5);
//                     instances.emplace_back(2, spheres[2].abs_offset(center), DIELECTRIC, dielectrics.size()-1);
//                 }
//             }
//         }
//     }
